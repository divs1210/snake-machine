...
return cljs.core.merge.call(null,initial_state,p1__6564_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_6565 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_6566 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_6565);
var pos_6567 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_6565);
quil.core.scale.call(null,zoom_6566);

var tr__6052__auto___6568 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_6566) - cljs.core.first.call(null,pos_6567)),(((quil.core.height.call(null) / (2)) / zoom_6566) - cljs.core.second.call(null,pos_6567))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__6052__auto___6568);
